 ...
 @section('content')
     <div class="mt-20">
         <h1 class="flex items-center justify-center font-bold text-orange-600 text-md lg:text-3xl">Check Out
         </h1>
     </div>
             ...
             <div class="flex flex-col w-full ml-0 lg:ml-12 lg:w-2/5">
                 <div class="pt-12 md:pt-0 2xl:ps-4">
                     ...
                     <div
                         ...
                         Subtotal<span class="ml-2">0 MAD</span></div>
                     <div
                         class="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                         Shipping Tax<span class="ml-2">0 MAD</span></div>
                     <div
                         class="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                         Total<span class="ml-2">{{ $totalprice }} MAD</span></div>
                 </div>
             </div>
         </div>
     </div>
