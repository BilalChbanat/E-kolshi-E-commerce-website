    ...
    <div class="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
        <div class="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
            <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
                <div>
                    <img src="{{ asset('images/logo.png') }}" class="w-32 mx-auto" />
                </div>
                        ...
                        <form action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mx-auto max-w-xs">
                                ...
                                <div class="mt-2 text-xs text-gray-600">
                                    ...
                                    <input id="aa" type="radio" class="border-b border-gray-500 border-dotted">
                                    <label for="aa"
                                        class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Terms and
                                        conditions
                                    </label>
                                </div>
            ...
            <div class="flex-1 bg-orange-100 text-center hidden lg:flex">
                <div class="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat"
                    style="background-image: url('images/Add to Cart-cuate.png');">
                </div>
            </div>
        </div>
    </div>
